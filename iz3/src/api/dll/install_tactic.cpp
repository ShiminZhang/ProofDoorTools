...
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_72, mk_qffplra_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_73, mk_nl_purify_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_74, mk_default_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_75, mk_sine_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_76, mk_qfbv_sls_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_77, mk_nra_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_78, mk_qfaufbv_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_79, mk_qfauflia_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_80, mk_qfbv_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_81, mk_qfidl_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_82, mk_qflia_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_83, mk_qflra_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_84, mk_qfnia_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_85, mk_qfnra_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_86, mk_qfuf_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_87, mk_qfufbv_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_88, mk_qfufbv_ackr_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_89, mk_qfufnra_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_90, mk_ufnia_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_91, mk_uflra_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_92, mk_auflia_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_93, mk_auflira_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_94, mk_aufnira_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_95, mk_lra_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_96, mk_lia_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_97, mk_lira_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_98, mk_skip_tactic());
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_99, mk_fail_tactic());
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_100, mk_fail_if_undecided_tactic());
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_101, mk_macro_finder_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_102, mk_quasi_macros_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_103, mk_quasi_macros_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_104, mk_ufbv_tactic(m, p));
MK_SIMPLE_TACTIC_FACTORY(__Z3_local_factory_105, mk_ufbv_tactic(m, p));
...
void install_tactics(tactic_manager & ctx) {
  ...
  ADD_TACTIC_CMD("qffplra", "(try to) solve goal using the tactic for QF_FPLRA.", __Z3_local_factory_72);
  ADD_TACTIC_CMD("nl-purify", "Decompose goal into pure NL-sat formula and formula over other theories.", __Z3_local_factory_73);
  ADD_TACTIC_CMD("default", "default strategy used when no logic is specified.", __Z3_local_factory_74);
  ADD_TACTIC_CMD("sine-filter", "eliminate premises using Sine Qua Non", __Z3_local_factory_75);
  ADD_TACTIC_CMD("qfbv-sls", "(try to) solve using stochastic local search for QF_BV.", __Z3_local_factory_76);
  ADD_TACTIC_CMD("nra", "builtin strategy for solving NRA problems.", __Z3_local_factory_77);
  ADD_TACTIC_CMD("qfaufbv", "builtin strategy for solving QF_AUFBV problems.", __Z3_local_factory_78);
  ADD_TACTIC_CMD("qfauflia", "builtin strategy for solving QF_AUFLIA problems.", __Z3_local_factory_79);
  ADD_TACTIC_CMD("qfbv", "builtin strategy for solving QF_BV problems.", __Z3_local_factory_80);
  ADD_TACTIC_CMD("qfidl", "builtin strategy for solving QF_IDL problems.", __Z3_local_factory_81);
  ADD_TACTIC_CMD("qflia", "builtin strategy for solving QF_LIA problems.", __Z3_local_factory_82);
  ADD_TACTIC_CMD("qflra", "builtin strategy for solving QF_LRA problems.", __Z3_local_factory_83);
  ADD_TACTIC_CMD("qfnia", "builtin strategy for solving QF_NIA problems.", __Z3_local_factory_84);
  ADD_TACTIC_CMD("qfnra", "builtin strategy for solving QF_NRA problems.", __Z3_local_factory_85);
  ADD_TACTIC_CMD("qfuf", "builtin strategy for solving QF_UF problems.", __Z3_local_factory_86);
  ADD_TACTIC_CMD("qfufbv", "builtin strategy for solving QF_UFBV problems.", __Z3_local_factory_87);
  ADD_TACTIC_CMD("qfufbv_ackr", "A tactic for solving QF_UFBV based on Ackermannization.", __Z3_local_factory_88);
  ADD_TACTIC_CMD("qfufnra", "builtin strategy for solving QF_UNFRA problems.", __Z3_local_factory_89);
  ADD_TACTIC_CMD("ufnia", "builtin strategy for solving UFNIA problems.", __Z3_local_factory_90);
  ADD_TACTIC_CMD("uflra", "builtin strategy for solving UFLRA problems.", __Z3_local_factory_91);
  ADD_TACTIC_CMD("auflia", "builtin strategy for solving AUFLIA problems.", __Z3_local_factory_92);
  ADD_TACTIC_CMD("auflira", "builtin strategy for solving AUFLIRA problems.", __Z3_local_factory_93);
  ADD_TACTIC_CMD("aufnira", "builtin strategy for solving AUFNIRA problems.", __Z3_local_factory_94);
  ADD_TACTIC_CMD("lra", "builtin strategy for solving LRA problems.", __Z3_local_factory_95);
  ADD_TACTIC_CMD("lia", "builtin strategy for solving LIA problems.", __Z3_local_factory_96);
  ADD_TACTIC_CMD("lira", "builtin strategy for solving LIRA problems.", __Z3_local_factory_97);
  ADD_TACTIC_CMD("skip", "do nothing tactic.", __Z3_local_factory_98);
  ADD_TACTIC_CMD("fail", "always fail tactic.", __Z3_local_factory_99);
  ADD_TACTIC_CMD("fail-if-undecided", "fail if goal is undecided.", __Z3_local_factory_100);
  ADD_TACTIC_CMD("macro-finder", "Identifies and applies macros.", __Z3_local_factory_101);
  ADD_TACTIC_CMD("quasi-macros", "Identifies and applies quasi-macros.", __Z3_local_factory_102);
  ADD_TACTIC_CMD("ufbv-rewriter", "Applies UFBV-specific rewriting rules, mainly demodulation.", __Z3_local_factory_103);
  ADD_TACTIC_CMD("bv", "builtin strategy for solving BV problems (with quantifiers).", __Z3_local_factory_104);
  ADD_TACTIC_CMD("ufbv", "builtin strategy for solving UFBV problems (with quantifiers).", __Z3_local_factory_105);
